...
those specific GenAI policies cannot run on your Agentic App’s endpoint. They operate strictly and exclusively on raw FRONTIER model(Anthropic Claude & Google Gemini) OR Model Marketplaces (WS Bedrock & Google Vertex AI) endpoints.
